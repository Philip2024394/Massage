...
import { LogOut, Shield, Users, MessageSquare, Edit, Trash2, Check, X, Building, Home } from 'lucide-react';
import { Link } from 'react-router-dom';
import { motion } from 'framer-motion';
import { User as UserType, TherapistProfile, MassagePlaceProfile, Review } from '../types';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'reviews' && <ReviewsTable reviews={reviews} profiles={[...therapists, ...places]} onUpdateReview={handleUpdateReview} onDeleteReview={handleDeleteReview} t={t} />}
      </main>
    </div>
  );
};
...
const ReviewsTable = ({ reviews, profiles, onUpdateReview, onDeleteReview, t }: any) => {
