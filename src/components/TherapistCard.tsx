...
import { Star, MapPin, Clock, MessageCircle, CheckCircle, Circle, Globe, Search } from 'lucide-react';
...
export const TherapistCard: React.FC<TherapistCardProps> = ({ therapist, onWhatsAppClick }) => {
